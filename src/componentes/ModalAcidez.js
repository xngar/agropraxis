              ...
              <table className="table table-responsive">
                ...
                <tbody>
                  ...
                  {info.ListaResultados.map(mapeo => {
                    ...
                    let sumatoria = 0.0;
                    let ResultadoSumJugo = 0;
                    let ValorJugoPeso = 0;
                    
                    mapeo.PesosFrutos.map(x => { sumatoria += x.Peso});
                    console.log(sumatoria);  
                   

                    ValorJugoPeso = mapeo.JugoPeso;
                    console.log(ValorJugoPeso);

                    ResultadoSumJugo = ((ValorJugoPeso / sumatoria) * 100);
                    console.log(ResultadoSumJugo);
